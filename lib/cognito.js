...
module.exports = {
  ...
  login: function(token, tokenSecret) {
    ...
    var identityId = credentials.identityPoolId().IdentityPoolId;
    console.log("Cognito identityPoolId", identityId);
    params = {
      IdentityId: 'eu-west-1:0732bbb6-439a-4b83-a4f1-ff8bbfc7a5ad', /* required */
      Logins: {
        someKey: loginToken
      }
    };
